---
title: "WGBS_cgigas_ploidy_Methylkit"
author: "Matt George"
date: "3/29/2021"
output: html_document
---

This script runs methylkit on the result of WGBS analysis of x5 diploid and triploid c.gigas exposed to desiccation stress at 27C for 24 hrs. This is a continuation of a pipeline outlined in a previous notebook entry that can be found [here](https://mattgeorgephd.github.io/Pt-Whitney-Bisulfide-analysis/)
...
```{r}
# Put all .bam files into a list for analysis. File paths are sourced from locally-mounted gannet server
analysisFiles <- list("/zr3534_1_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_2_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_3_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_4_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_5_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_6_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_7_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_8_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_9_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam,
                      /zr3534_10_R1.fastp-trim.20201202_bismark_bt2_pe.deduplicated.sorted.bam") 
